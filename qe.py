...
parser.add_argument("--transfer_tasks", type=str, default="",
                    help="Transfer tasks, example: 'DA,HTER' ")
...
parser.add_argument("--data_path", type=str, default="",
                    help="Data path")
parser.add_argument("--data_split", type=str, default="train,dev",  # new
                    help="Data splits, can also be 'train,dev,test'")
parser.add_argument("--lang", type=str, default="en,de",  # new
                    help="Languages of QE tasks, can also be 'en,zh'")
...
# debug
parser.add_argument("--debug_data", type=bool_flag, default=False,
...
# data
params.data_split = params.data_split.split(',')
